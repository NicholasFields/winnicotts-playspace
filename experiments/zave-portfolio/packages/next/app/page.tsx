				...
				<div id="scripted-page">
					<header id="main-navbar">
						...
						<span id="navbar-command"
							...
							<span id="full-navbar-command"
								className="navbar-command-text">&nbsp;navigate&nbsp;</span>
							<span id="mini-navbar-command"
								className="navbar-command-text">&nbsp;nav&nbsp;</span>
						</span>
						<nav id="navbar-links"
							className="navbar-start-hidden">
							<ul>
					...
					<div id="page-content">
						<section id="home"
							...
							</span><span id="name-header"
								className="wordart-header type-contents">nametext</span>
							<p className="type-contents">(fullstack node.js developer)</p>
							<nav className="link-list">
								<a className="type-contents"
									href="#about">[learn about me]</a>
								<a className="type-contents"
									href="#projects">[cool projects]</a>
								<a className="type-contents"
									href="#contact">[chat with me]</a>
							</nav>
							<noscript>
								<br />
						...
						<section id="projects"
							...
							<table id="projects-table">
								<tr>
									...
									<td><a className="github-link type-contents"
										href="https://github.com/NicholasFields/proj-name"
										target="_blank"
										rel="noreferrer">[github]</a></td>
								</tr>
							</table>
						</section>
						<section id="contact"
							...
							<nav>
								...
								<table id="contact-info">
									<tr>
										<td><a className="type-contents bracket-link"
											href="mailto:nick@jsondoe.com"
											target="_blank"
											style={{ color: '#6D4AFF' }}
											rel="noreferrer">[email]</a></td>
										<td className="type-contents">nick@jsondoe.com</td>
									</tr>
									<tr>
										<td><a className="type-contents"
											href="https://twitter.com/twitterhandle"
											target="_blank"
											style={{ color: '#1D9BF0' }}
											rel="noreferrer">[twitter]</a></td>
										<td className="type-contents">@twitterhandle</td>
									</tr>
									<tr>
										<td className="type-contents"
											style={{ color: '#454FBF ' }}>[discord]</td>
										<td className="type-contents">discordhandle</td>
									</tr>
									<tr>
										<td><a className="type-contents github-link"
