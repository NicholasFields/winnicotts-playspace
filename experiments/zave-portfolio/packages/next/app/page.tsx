						...
						<section id="projects" className="active-section">
							...
							<table id="projects-table">
								<tr>
									...
									<td><a className="github-link type-contents" href="https://github.com/NicholasFields/proj-name" target="_blank" rel="noreferrer">[github]</a></td>
								</tr>
							</table>
						</section>
						<section id="contact" className="active-section">
							...
							<nav>
								...
								<table id="contact-info">
									<tr>
										<td><a className="type-contents bracket-link" href="mailto:nick@jsondoe.com" target="_blank" style={{ color: '#6D4AFF' }} rel="noreferrer">[email]</a></td>
										<td className="type-contents">nick@jsondoe.com</td>
									</tr>
									<tr>
										<td><a className="type-contents" href="https://twitter.com/twitterhandle" target="_blank" style={{ color: '#1D9BF0' }} rel="noreferrer">[twitter]</a></td>
									...
									<tr>
										<td><a className="type-contents github-link" href="https://github.com/NicholasFields" target="_blank" rel="noreferrer">[github]</a></td>
